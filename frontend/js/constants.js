...
const welcome_h1 = "Welcome to Queen Elizabeth II NFTs";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = "999 Commemorative Queen Elizabeth II NFTs celebrating the iconic style of Her Majesty the Queen";
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Mint is Open!!";
